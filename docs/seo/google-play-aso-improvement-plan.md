...
| **E5** | "Share as image" for decks and tournament standings, with a subtle brand footer | `DeckStudioScreen.kt`, tournament detail screen | Keep the plain-text export unchanged for imports |
