...
data class CardValueProjection(val scryfallId: String, val name: String, val priceUsd: Double, val isFoil: Boolean, val imageArtCrop: String?, val colorIdentity: String = "")
