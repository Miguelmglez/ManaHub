package com.mmg.magicfolder.core.domain.usecase.symbols

import com.mmg.magicfolder.core.data.local.dao.ManaSymbolDao
import com.mmg.magicfolder.core.data.local.entity.ManaSymbolEntity
