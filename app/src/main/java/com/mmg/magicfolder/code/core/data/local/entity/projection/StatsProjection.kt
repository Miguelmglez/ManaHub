package com.mmg.magicfolder.code.core.data.local.entity.projection


data class TotalsProjection(val totalCards: Int, val uniqueCards: Int)
data class CardValueProjection(val scryfallId: String, val name: String, val priceUsd: Double, val isFoil: Boolean, val imageArtCrop: String?)
