...
/** Width of a draft set tile (Latest sets). */
internal val HomeDraftSetTileWidth: Dp = 180.dp
...
private val DraftSetIconSize = 48.dp
private val DraftSetTitleMinHeight = 40.dp
private val DraftSetInnerPadding = 12.dp
private val DraftSetBadgeVerticalPadding = 4.dp
private val DraftSetIconGap = 8.dp
private val DraftSetMetaGap = 4.dp
...
fun computeHomeWidgetMetrics(lh: HomeLineHeights, sp: Spacing): HomeWidgetMetrics {
    ...
    val draftSetTile = DraftSetInnerPadding * 2 + DraftSetIconSize + DraftSetIconGap +
        max(DraftSetTitleMinHeight, lh.labelLarge * 2) + DraftSetMetaGap +
        lh.labelSmall + DraftSetBadgeVerticalPadding + SlotSlack
