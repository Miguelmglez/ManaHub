...
internal fun String.toStringList(): List<String> = _root_ide_package_.core.data.remote.mapper.gson.fromJson(this,
    _root_ide_package_.core.data.remote.mapper.listType
) ?: emptyList()
internal fun List<String>.toJson(): String = _root_ide_package_.core.data.remote.mapper.gson.toJson(this)
